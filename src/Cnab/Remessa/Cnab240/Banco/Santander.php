...
namespace Alves\LaravelBoleto\Cnab\Remessa\Cnab240\Banco;

use Alves\LaravelBoleto\CalculoDV;
use Alves\LaravelBoleto\Cnab\Remessa\Cnab240\AbstractRemessa;
use Alves\LaravelBoleto\Contracts\Boleto\Boleto as BoletoContract;
use Alves\LaravelBoleto\Contracts\Cnab\Remessa as RemessaContract;
...
class Santander extends AbstractRemessa implements RemessaContract
{
    ...
    protected function segmentoP(BoletoContract $boleto)
    {
        ...
        $this->add(118, 118, ($boleto->getJuros() !== null && $boleto->getJuros() > 0) ? '2' : '3');    //3 = ISENTO | 1 = R$ ao dia | 2 = % ao mÃªs
        ...
        $this->add(224, 224, $boleto->getDiasBaixaAutomatica() > 0 ? '1' : '3'); // 1 = Baixar/Devolver / 2 = NÃ£o Baixar / 3 = Perfil do BenefÃ­ciario (ConfiguraÃ§Ã£o do Banco)
