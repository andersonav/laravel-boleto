...
class Itau extends AbstractRetorno implements RetornoCnab400
{
    ...
    private $ocorrencias = [
        ...
        '65' => 'Pagamento com cheque - aguardando compensacÌ§aÌƒo',
        '69' => 'Cheque devolvido',
        ...
        '80' => 'ConfirmacÌ§aÌƒo de entrada em negativacÌ§aÌƒo expressa - tarifa',
        '82' => 'ConfirmacÌ§aÌƒo do cancelamento de negativacÌ§aÌƒo expressa - tarifa',
        '83' => 'ConfirmacÌ§aÌƒo de exclusaÌƒo de entrada em negativacÌ§aÌƒo expressa por liquidacÌ§aÌƒo - tarifa',
