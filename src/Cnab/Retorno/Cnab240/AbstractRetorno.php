<?php
namespace Alves\LaravelBoleto\Cnab\Retorno\Cnab240;

use \Alves\LaravelBoleto\Cnab\Retorno\AbstractRetorno as AbstractRetornoGeneric;
use Alves\LaravelBoleto\Contracts\Cnab\Retorno\Cnab240\HeaderLote as HeaderLoteContract;
use Alves\LaravelBoleto\Contracts\Cnab\Retorno\Cnab240\TrailerLote as TrailerLoteContract;
use Illuminate\Support\Collection;

/**
 * Class AbstractRetorno
 *
 * @method  \Alves\LaravelBoleto\Cnab\Retorno\Cnab240\Detalhe getDetalhe()
 * @method  \Alves\LaravelBoleto\Cnab\Retorno\Cnab240\Header getHeader()
 * @method  \Alves\LaravelBoleto\Cnab\Retorno\Cnab240\Trailer getTrailer()
 * @method  \Alves\LaravelBoleto\Cnab\Retorno\Cnab240\Detalhe detalheAtual()
 * @package Alves\LaravelBoleto\Cnab\Retorno\Cnab240
 */
abstract class AbstractRetorno extends AbstractRetornoGeneric
{
     ...
     * @return boolean
     */
    abstract protected function processarHeader($header);
     ...
     * @return boolean
     */
    abstract protected function processarHeaderLote($headerLote);
     ...
     * @return boolean
     */
    abstract protected function processarDetalhe($detalhe);
     ...
     * @return boolean
     */
    abstract protected function processarTrailerLote($trailer);
     ...
     * @return boolean
     */
    abstract protected function processarTrailer($trailer);
